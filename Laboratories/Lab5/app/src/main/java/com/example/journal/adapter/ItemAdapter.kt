...
class ItemAdapter(private val context: ListViewActivity): RecyclerView.Adapter<ItemAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        val item = storyRepository.getStories()[position]
        ...
        holder.itemView.deleteButton.setOnClickListener{
            ...
            var storyTitle = storyRepository.getStories()[position].title
            storyTitle += " ?"
        ...
        holder.itemView.editButton.setOnClickListener(){
            ...
            bundle.putParcelable("story", storyRepository.getStories()[position]);
            intent.putExtra("storyBundle", bundle);
            intent.putExtra("id", storyRepository.getStories()[position].id);
    ...
    override fun getItemCount(): Int {
        return storyRepository.getStories().size
    }
